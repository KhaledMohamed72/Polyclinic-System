<ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
    <li class="nav-item">
        <a class="nav-link {{ request()->routeIs('today-appointment') ? 'active' : '' }}" href="{{route('today-appointment')}}">
    ...
    <li class="nav-item">
        <a class="nav-link {{ request()->routeIs('pending-appointment') ? 'active' : '' }}" href="{{route('pending-appointment')}}">
    ...
    <li class="nav-item">
        <a class="nav-link {{ request()->routeIs('upcoming-appointment') ? 'active' : '' }}" href="{{route('upcoming-appointment')}}">
    ...
    <li class="nav-item">
        <a class="nav-link {{ request()->routeIs('complete-appointment') ? 'active' : '' }}" href="{{route('complete-appointment')}}">
    ...
    <li class="nav-item">
        <a class="nav-link {{ request()->routeIs('cancel-appointment') ? 'active' : '' }}" href="{{route('cancel-appointment')}}">
