...
<div class="card-body">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <label for="exampleInput{{$input}}">{{ trans('main_trans.naote') }}</label>
            <textarea name="{{$input}}" class="form-control" rows="3" placeholder="" spellcheck="false">{{isset($row) ? $row->$input : old($input)}}</textarea>
