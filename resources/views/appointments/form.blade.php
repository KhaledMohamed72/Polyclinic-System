...
<div class="card-body">
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                <label>Patient</label>
                <select name="{{$input}}" class="form-control select2 sel-doctor" style="width: 100%;" id="doctor">
    ...
    @if($count_doctors > 1)
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <label>Doctor</label>
                    <select name="{{$input}}" class="form-control select2 sel-doctor" id="doctor" style="width: 100%;">
    ...
    <div class="row">
        <div class="col-md-6 form-group datepickerdiv">
            ...
            <div class="form-group datepickerdiv">
