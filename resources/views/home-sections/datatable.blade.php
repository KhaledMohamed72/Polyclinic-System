                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($row->status == 'pending')
                                                        <span
                                                            class="badge badge-info">{{ trans('main_trans.pending') }}</span>
                                                    @elseif($row->status == 'cancel')
                                                        <span
                                                            class="badge badge-danger">{{ trans('main_trans.cancel') }}</span>
                                                    @elseif($row->status == 'complete')
                                                        <span
                                                            class="badge badge-primary">{{ trans('main_trans.complete') }}</span>
                                                    @else
                                                    @endif
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="project-actions text-left">
                                                    ...
                                                    @if (auth()->user()->hasRole('doctor'))
                                                        ...
                                                        <form action="{{ route('prescriptions.destroy', $row->id) }}"
